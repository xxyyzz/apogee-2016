...
# 	url(r'^firewallzouter/confirm/(?P<crep_id>\d+)$', firewallzo_setgleader),
	...
	url(r'^firewallzouter/gcodes/$', gcodelist),
	url(r'^firewallzouter/gcodes/(?P<gl_id>\d+)/$', grp_details),
# 	url(r'^firewallzouter/testx/$', testx),
	# url(r'^firewallzouter/unconfirm/(?P<part_id>\d+)$', firewallzo_unconfirm),
	url(r'^firewallzouter/unconfirm/$', unconfirm_list),
	url(r'^firewallzouter/unconfirm/(?P<glid>\d+)/$', fire_unconfirm),
