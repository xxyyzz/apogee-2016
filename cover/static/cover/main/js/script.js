...
function eve_reg_info(){
	$.ajax({
		url: "http://bits-apogee.org/2016/api/events/status/",
		method: "GET",
		success: function(data){
...
var map_ele_info = {
	'thinkAgainConclave'	:		{
										...
										icon: imgpre+'cover/main/img/lb-icons/thinkAgain.svg',
										func:content_link,
									},
	'dhiti'					:		{
										ename:'Dhiti',
										...
										icon: imgpre+'cover/main/img/lb-icons/dhiti.svg',
										func:content_link,
									},
	...
	'startupWeekend'		:		{
										...
										icon: imgpre+'cover/main/img/lb-icons/startupWeekend.svg',
										func:content_link,
									},
	...
	'iot'					:		{
										...
										icon: imgpre+'cover/main/img/lb-icons/iotc.svg',
										func:content_link,
									},
	...
	'youthCon'				:		{
										...
										icon: imgpre+'cover/main/img/lb-icons/youthcon.svg',
										func:content_link,
									},
	...
	'profShow'				:		{
										...
										icon: imgpre+'cover/main/img/lb-icons/profshows.svg',
										func:content_link,
									},
	...
	'accomodation'			:		{
										...
										icon: imgpre+'cover/main/img/lb-icons/accomodation.svg',
										func:content_link,
									},
	...
	'projects'				:		{
										ename:'Projects',
										content:'',
										icon: imgpre+'cover/main/img/lb-icons/project.svg',
										func:content_link,
									},
	...
	'aic'					:		{
										...
										icon: imgpre+'cover/main/img/lb-icons/aic.svg',
										func:content_link,
									},

	'archives'				:		{
										ename:'Archives',
										content:'<div class="archive_data"><div class="archive-holder"><img src="'+imgpre+'cover/main/img/archive/ap14.jpg" class="arch-img"/><a class="arch-lnk" href="http://bits-apogee.org/2014/"><i class="fa fa-globe"></i>&nbsp;&nbsp;APOGEE 2014</a></div><div class="archive-holder"><img src="'+imgpre+'cover/main/img/archive/ap15i.jpg" class="arch-img"/><a class="arch-lnk" href="http://bits-apogee.org/u/intro"><i class="fa fa-globe"></i>&nbsp;&nbsp;APOGEE 2015 Intro<a></div><div class="archive-holder"><img src="'+imgpre+'cover/main/img/archive/ap15.jpg" class="arch-img"/><a class="arch-lnk" href="http://bits-apogee.org/u/2015"><i class="fa fa-globe"></i>&nbsp;&nbsp;APOGEE 2015 </a></div><div class="archive-holder"><img src="'+imgpre+'cover/main/img/archive/ap16i.jpg" class="arch-img"/><a class="arch-lnk" href="http://bits-apogee.org/"><i class="fa fa-globe"></i>&nbsp;&nbsp;APOGEE 2016 Intro</a></div></div>',
										icon: imgpre+'cover/main/img/lb-icons/archives.svg',
										func:content_link,
									},
	...
	'literaryFest'			:		{
										ename:'Literary Fest',
										content:'<div class="c_soon">Coming soon...</div>',
										icon: imgpre+'cover/main/img/lb-icons/literaryFest.svg',
										func:content_link,
									},
	...
	'armyExhibition'			:	{
										...
										content:'<div class="c_soon">Coming soon...</div>',
										icon: imgpre+'cover/main/img/lb-icons/army.svg',
										func:content_link,
									},
	...
	'campusAmbassador'		:		{
										...
										icon: imgpre+'cover/main/img/lb-icons/campus.svg',
										func:content_link,
									},
	...
	'papers'				:		{
										ename:'Papers',
										content:'',
										icon: imgpre+'cover/main/img/lb-icons/paper.svg',
										func:content_link,
									},
	...
	'sponsors'				:		{
										ename:'Sponsors',
										content:'',
										icon: imgpre+'cover/main/img/lb-icons/spons.svg',
										func:content_link,
									},
	...
	'ceeriExhibition'		:		{
										...
										content:'<div class="c_soon">Coming soon...</div>',
										icon: imgpre+'cover/main/img/lb-icons/ceeri.svg',
										func:content_link,
									},

	'contactUs'				:		{
										ename:'Contacts',
										content:'<div class="contact_data" id="c_data"><div class="contactinfo"><div class="contact_dept">President</div><div style="position:relative"><img src="'+imgpre+'cover/main/img/contacts/prez.jpg" class="contact_img"><a href="https://www.facebook.com/akhil.reddy.148" target="_blank"><div class="fb_link"><!--?xml version="1.0" ?--><svg class="confb" enable-background="new 0 0 56.693 56.693" height="30px" id="Layer_1" version="1.1" viewBox="0 0 56.693 56.693" width="30px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><style type="text/css">svg .confb{ cursor: pointer;transition: 150ms;transition-timing-function: ease-in-out;-webkit-transition: 150ms;-webkit-transition-timing-function: ease-in-out;fill:#fff;} .confb:hover{ fill: #3b5998;}</style><path d="M40.43,21.739h-7.645v-5.014c0-1.883,1.248-2.322,2.127-2.322c0.877,0,5.395,0,5.395,0V6.125l-7.43-0.029  c-8.248,0-10.125,6.174-10.125,10.125v5.518h-4.77v8.53h4.77c0,10.947,0,24.137,0,24.137h10.033c0,0,0-13.32,0-24.137h6.77  L40.43,21.739z"></path></svg></div></a></div><div class="contact_det"><b>AKHIL REDDY</b><br>+91-7728835792<br>president[at]pilani.bits-pilani.ac.in</div></div><div class="contactinfo"><div class="contact_dept">General Secretary</div><div style="position:relative"><img src="'+imgpre+'cover/main/img/contacts/gen.jpg" class="contact_img"><a href="https://www.facebook.com/rijul.dutta" target="_blank"><div class="fb_link"><!--?xml version="1.0" ?--><svg class="confb" enable-background="new 0 0 56.693 56.693" height="30px" id="Layer_1" version="1.1" viewBox="0 0 56.693 56.693" width="30px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><style type="text/css">svg .confb{ cursor: pointer;transition: 150ms;transition-timing-function: ease-in-out;-webkit-transition: 150ms;-webkit-transition-timing-function: ease-in-out;fill:#fff;} .confb:hover{ fill: #3b5998;}</style><path d="M40.43,21.739h-7.645v-5.014c0-1.883,1.248-2.322,2.127-2.322c0.877,0,5.395,0,5.395,0V6.125l-7.43-0.029  c-8.248,0-10.125,6.174-10.125,10.125v5.518h-4.77v8.53h4.77c0,10.947,0,24.137,0,24.137h10.033c0,0,0-13.32,0-24.137h6.77  L40.43,21.739z"></path></svg></div></a></div><div class="contact_det"><b>RIJUL DUTTA</b><br>+91-8427686647<br>gensec[at]pilani.bits-pilani.ac.in</div></div><div class="contactinfo"><div class="contact_dept">For sponsorship and marketing</div><div style="position:relative"><img src="'+imgpre+'cover/main/img/contacts/spons.jpg" class="contact_img"><a href="https://www.facebook.com/mohammed.motiwala1" target="_blank"><div class="fb_link"><!--?xml version="1.0" ?--><svg class="confb" enable-background="new 0 0 56.693 56.693" height="30px" id="Layer_1" version="1.1" viewBox="0 0 56.693 56.693" width="30px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><style type="text/css">svg .confb{ cursor: pointer;transition: 150ms;transition-timing-function: ease-in-out;-webkit-transition: 150ms;-webkit-transition-timing-function: ease-in-out;fill:#fff;} .confb:hover{ fill: #3b5998;}</style><path d="M40.43,21.739h-7.645v-5.014c0-1.883,1.248-2.322,2.127-2.322c0.877,0,5.395,0,5.395,0V6.125l-7.43-0.029  c-8.248,0-10.125,6.174-10.125,10.125v5.518h-4.77v8.53h4.77c0,10.947,0,24.137,0,24.137h10.033c0,0,0-13.32,0-24.137h6.77  L40.43,21.739z"></path></svg></div></a></div><div class="contact_det"><b>MOHAMMED MOTIWALA</b><br>+91-7728086752<br>sponsorship[at]bits-apogee[dot]org</div></div><div class="contactinfo"><div class="contact_dept">For invites and correspondence</div><div style="position:relative"><img src="'+imgpre+'cover/main/img/contacts/pcr.jpg" class="contact_img"><a href="https://www.facebook.com/profile.php?id=100006361090120" target="_blank"><div class="fb_link"><!--?xml version="1.0" ?--><svg class="confb" enable-background="new 0 0 56.693 56.693" height="30px" id="Layer_1" version="1.1" viewBox="0 0 56.693 56.693" width="30px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><style type="text/css">svg .confb{ cursor: pointer;transition: 150ms;transition-timing-function: ease-in-out;-webkit-transition: 150ms;-webkit-transition-timing-function: ease-in-out;fill:#fff;} .confb:hover{ fill: #3b5998;}</style><path d="M40.43,21.739h-7.645v-5.014c0-1.883,1.248-2.322,2.127-2.322c0.877,0,5.395,0,5.395,0V6.125l-7.43-0.029  c-8.248,0-10.125,6.174-10.125,10.125v5.518h-4.77v8.53h4.77c0,10.947,0,24.137,0,24.137h10.033c0,0,0-13.32,0-24.137h6.77  L40.43,21.739z"></path></svg></div></a></div><div class="contact_det"><b>ADITYA CHAUHAN</b><br>+91-8239822574<br>pcr[at]bits-apogee[dot]org</div></div><div class="contactinfo"><div class="contact_dept">For paper presentations and Guest Lectures</div><div style="position:relative"><img src="'+imgpre+'cover/main/img/contacts/pep.jpg" class="contact_img"><a href="https://www.facebook.com/adivijaykumar" target="_blank"><div class="fb_link"><!--?xml version="1.0" ?--><svg class="confb" enable-background="new 0 0 56.693 56.693" height="30px" id="Layer_1" version="1.1" viewBox="0 0 56.693 56.693" width="30px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><style type="text/css">svg .confb{ cursor: pointer;transition: 150ms;transition-timing-function: ease-in-out;-webkit-transition: 150ms;-webkit-transition-timing-function: ease-in-out;fill:#fff;} .confb:hover{ fill: #3b5998;}</style><path d="M40.43,21.739h-7.645v-5.014c0-1.883,1.248-2.322,2.127-2.322c0.877,0,5.395,0,5.395,0V6.125l-7.43-0.029  c-8.248,0-10.125,6.174-10.125,10.125v5.518h-4.77v8.53h4.77c0,10.947,0,24.137,0,24.137h10.033c0,0,0-13.32,0-24.137h6.77  L40.43,21.739z"></path></svg></div></a></div><div class="contact_det"><b>ADITYA VIJAYKUMAR</b><br>+91-8385857855, +91-8058722661<br>pep[at]bits-apogee[dot]org, guestlectures[at]bits-apogee[dot]org</div></div><div class="contactinfo"><div class="contact_dept">For website and online registration queries</div><div style="position:relative"><img src="'+imgpre+'cover/main/img/contacts/dvm.jpg" class="contact_img"><a href="https://www.facebook.com/pranjalONfb" target="_blank"><div class="fb_link"><!--?xml version="1.0" ?--><svg class="confb" enable-background="new 0 0 56.693 56.693" height="30px" id="Layer_1" version="1.1" viewBox="0 0 56.693 56.693" width="30px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><style type="text/css">svg .confb{ cursor: pointer;transition: 150ms;transition-timing-function: ease-in-out;-webkit-transition: 150ms;-webkit-transition-timing-function: ease-in-out;fill:#fff;} .confb:hover{ fill: #3b5998;}</style><path d="M40.43,21.739h-7.645v-5.014c0-1.883,1.248-2.322,2.127-2.322c0.877,0,5.395,0,5.395,0V6.125l-7.43-0.029  c-8.248,0-10.125,6.174-10.125,10.125v5.518h-4.77v8.53h4.77c0,10.947,0,24.137,0,24.137h10.033c0,0,0-13.32,0-24.137h6.77  L40.43,21.739z"></path></svg></div></a></div><div class="contact_det"><b>PRANJAL GUPTA</b><br>+91-8094076999<br>webmaster[at]bits-apogee[dot]org</div></div><div class="contactinfo"><div class="contact_dept">For projects, events and registration</div><div style="position:relative"><img src="'+imgpre+'cover/main/img/contacts/controls.jpg" class="contact_img"><a href="https://www.facebook.com/falguni.agrawal.965" target="_blank"><div class="fb_link"><!--?xml version="1.0" ?--><svg class="confb" enable-background="new 0 0 56.693 56.693" height="30px" id="Layer_1" version="1.1" viewBox="0 0 56.693 56.693" width="30px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><style type="text/css">svg .confb{ cursor: pointer;transition: 150ms;transition-timing-function: ease-in-out;-webkit-transition: 150ms;-webkit-transition-timing-function: ease-in-out;fill:#fff;} .confb:hover{ fill: #3b5998;}</style><path d="M40.43,21.739h-7.645v-5.014c0-1.883,1.248-2.322,2.127-2.322c0.877,0,5.395,0,5.395,0V6.125l-7.43-0.029  c-8.248,0-10.125,6.174-10.125,10.125v5.518h-4.77v8.53h4.77c0,10.947,0,24.137,0,24.137h10.033c0,0,0-13.32,0-24.137h6.77  L40.43,21.739z"></path></svg></div></a></div><div class="contact_det"><b>FALGUNI AGRAWAL</b><br>+91-9928089204<br>controls[at]bits-apogee[dot]org</div></div><div class="contactinfo"><div class="contact_dept">For Publicity and Online Partnership</div><div style="position:relative"><img src="'+imgpre+'cover/main/img/contacts/adp.jpg" class="contact_img"><a href="https://www.facebook.com/kunal.barapatre.31" target="_blank"><div class="fb_link"><!--?xml version="1.0" ?--><svg class="confb" enable-background="new 0 0 56.693 56.693" height="30px" id="Layer_1" version="1.1" viewBox="0 0 56.693 56.693" width="30px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><style type="text/css">svg .confb{ cursor: pointer;transition: 150ms;transition-timing-function: ease-in-out;-webkit-transition: 150ms;-webkit-transition-timing-function: ease-in-out;fill:#fff;} .confb:hover{ fill: #3b5998;}</style><path d="M40.43,21.739h-7.645v-5.014c0-1.883,1.248-2.322,2.127-2.322c0.877,0,5.395,0,5.395,0V6.125l-7.43-0.029  c-8.248,0-10.125,6.174-10.125,10.125v5.518h-4.77v8.53h4.77c0,10.947,0,24.137,0,24.137h10.033c0,0,0-13.32,0-24.137h6.77  L40.43,21.739z"></path></svg></div></a></div><div class="contact_det"><b>KUNAL BARAPATRE</b><br>+91-7728095594<br>adp[at]bits-apogee[dot]org</div></div><div class="contactinfo"><div class="contact_dept">For reception and accommodation</div><div style="position:relative"><img src="'+imgpre+'cover/main/img/contacts/recnacc.jpg" class="contact_img"><a href="https://www.facebook.com/aditya.gogri" target="_blank"><div class="fb_link"><!--?xml version="1.0" ?--><svg class="confb" enable-background="new 0 0 56.693 56.693" height="30px" id="Layer_1" version="1.1" viewBox="0 0 56.693 56.693" width="30px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><style type="text/css">svg .confb{ cursor: pointer;transition: 150ms;transition-timing-function: ease-in-out;-webkit-transition: 150ms;-webkit-transition-timing-function: ease-in-out;fill:#fff;} .confb:hover{ fill: #3b5998;}</style><path d="M40.43,21.739h-7.645v-5.014c0-1.883,1.248-2.322,2.127-2.322c0.877,0,5.395,0,5.395,0V6.125l-7.43-0.029  c-8.248,0-10.125,6.174-10.125,10.125v5.518h-4.77v8.53h4.77c0,10.947,0,24.137,0,24.137h10.033c0,0,0-13.32,0-24.137h6.77  L40.43,21.739z"></path></svg></div></a></div><div class="contact_det"><b>ADITYA GOGRI</b><br>+91-9772229698<br>recnacc[at]bits-apogee[dot]org</div></div></div>',
										icon: imgpre+'cover/main/img/lb-icons/contacts.svg',
										func:content_link,
									},

	'howToReach'			:		{
										ename:'Reach 333031',
										content:'<div id="google-map"></div><h3>Travelling by car/taxi from Delhi</h3><p>There are three routes to get here, distance is 200 or 220 km depending on route taken and time taken is about 4.5 hours. In preferential order the routes are: Delhi-Gurgaon-Dharuheda-Rewari-MahendraGarh-Loharu-Pilani Delhi-Gurgaon-Dharuheda-Rewari-Narnaul-Singhana-Chirawa-Pilani Delhi-Rohtak-Bhiwani-Loharu-Pilani</p><h3>Travelling by bus from Delhi</h3><p>In case you prefer to travel by public transport, you need to catch a bus at the Inter State Bus Terminal (ISBT), Kashmiri Gate, Delhi. There are frequent buses to Pilani from Delhi from around 4:55 AM to 10:00 PM.</p><h3>Travelling by bus from Jaipur</h3><p>In case you prefer to travel by public transport, you need to catch a bus from the State Bus Terminal (Sindhi Camp), Jaipur. There are frequent buses to Pilani starting from Jaipur from around 4:00 AM till mid-night.</p><h3>Travelling by train from Jaipur</h3><p>Trains run from Jaipur to Chirawa (16 km from Pilani) or Loharu (26 km from Pilani). From Loharu or Chirawa you can take bus or cab to Pilani.</p><script type="text/javascript">function initMap() {var myLatLng = {lat: 28.364, lng: 75.587};var map = new google.maps.Map(document.getElementById("google-map"), {center: myLatLng,scrollwheel: true,zoom: 15});var image ="'+imgpre+'cover/main/img/marker.png";marker = new google.maps.Marker({ position: new google.maps.LatLng(28.364, 75.5871271),map: map ,icon: image });}setTimeout(function() {initMap()	}, 1000);</script>',
										icon: imgpre+'cover/main/img/lb-icons/map.svg',
										func:content_link,
									},
	...
	'about'					:		{
										...
										icon: imgpre+'cover/main/img/lb-icons/about.svg',
										func:content_link,
									},
	...
	'workshops'			:		{
										ename:'Workshops',
										content:'<div class="c_soon">Coming soon...</div>',
										icon: imgpre+'cover/main/img/lb-icons/workshops.svg',
										func:content_link,
									},
