...
postmarkbackend = EmailBackend(
    host='smtp.postmarkapp.com',
    port=587,
    username='6ae03e73-b530-4cff-ba11-109f45406b08',
    password='6ae03e73-b530-4cff-ba11-109f45406b08',
    use_tls=True,
    fail_silently=False,
)
...
Your APOGEE profile will soon have a confirmation page with a unique confirmation ID. Please login to the website www.bits-apogee.org and get a print out of the confirmation page before coming to the fest.
...
Kindly ensure all your team members have received a similar confirmation mail and a unique confirmation ID.

Keep checking the website and your profile for more updates on APOGEE 2016.Apart from technical events, this time in APOGEE-2016 we have:

1. National Disaster Response Force's Exhibition
2. CSIR -CEERI's Exhibition
3. Abish Mathew (A.I.B.) and Aflatunes( A Capella, Musical Prof Show)
4. ATVs (quad bikes) in the adventure zone!
5. Armageddon (Fifa, Counter-strike, Clash of Clans and many more!) (Exciting Prizes waiting for you!).
6. Literature Fest
7. Guest Lectures by Richard Stallman (Founder, GNU Project), M.J. Akbar (National Spokesperson, BJP) and many more!

Also check out:
https://www.facebook.com/bitsapogee


For any queries regarding confirmation/participation contact:

Aditya Chauhan +918239822574
pcr@bits-apogee.org
